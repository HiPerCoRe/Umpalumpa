#include <tests/operations/correlation/acorrelation_common.hpp>
...
{
public:
  Correlation_StarPU &GetOp() override { return transformer; }
...
#include <tests/operations/correlation/correlation_tests.hpp>
