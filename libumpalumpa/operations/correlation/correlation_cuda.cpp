...
namespace {// to avoid poluting
  inline static const auto kKernelFile =
    utils::GetSourceFilePath("libumpalumpa/operations/correlation/correlation_cuda_kernels.cu");
  ...
  struct Strategy1 : public Correlation_CUDA::KTTStrategy
  {
    ...
    // for now with all the current operations, but some changes or new operations might cause
    // issues.
